...
ALTER TABLE
    "integrations" RENAME CONSTRAINT "integrations_name_unique" TO "uq_integrations_name";

--> statement-breakpoint
ALTER TABLE
    "assoc_cluster_connections" DROP CONSTRAINT "assoc_instance_connections_instance_id_fkey";

--> statement-breakpoint
ALTER TABLE
    "aws_clusters" DROP CONSTRAINT "instances_integration_fkey";
...
ADD
    CONSTRAINT "assoc_instance_connections_instance_id_fkey" FOREIGN KEY ("cluster_id") REFERENCES "public"."aws_clusters"("id") ON DELETE no action ON UPDATE no action;

--> statement-breakpoint
ALTER TABLE
    "aws_clusters"
ADD
    CONSTRAINT "fk_aws_clusters_integration_name" FOREIGN KEY ("integration") REFERENCES "public"."integrations"("name") ON DELETE no action ON UPDATE no action;
...
ALTER TABLE
    "aws_clusters"
ADD
    CONSTRAINT "uq_aws_clusters_integration_identifier" UNIQUE("cluster_identifier", "integration");
...
ALTER TABLE
    "connections"
ADD
    CONSTRAINT "uq_connections_connection_string" UNIQUE("connection_string");
